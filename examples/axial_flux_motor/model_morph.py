...
#     DirichletBcMorph,
#     NodeSourceMorph,
#     DirichletBcMorphToothThicknessPos_dy,
#     DirichletBcMorphToothThicknessNeg_dy,
#     DirichletBcMorphAirGapPos_dy,
#     DirichletBcMorphAirGapNeg_dy,
#     PlaneStress,
#     PointForce,
# )
...
# # Define components
# ps = PlaneStress()
# dirichlet = DirichletBcMorph()
# dirichlet_tooth_thickness_pos = DirichletBcMorphToothThicknessPos_dy()
# dirichlet_tooth_thickness_neg = DirichletBcMorphToothThicknessNeg_dy()
# dirichlet_ag_pos = DirichletBcMorphAirGapPos_dy()
# dirichlet_ag_neg = DirichletBcMorphAirGapNeg_dy()
# node_src = NodeSourceMorph()
# force = PointForce()

# # Stator components
# model.add_component("stator_ps", nelems_stator, ps)
# model.add_component("stator_node_src", nnodes_stator, node_src)
# model.add_component("stator_dirichlet_left", len(stator_pbc_nodes_left), dirichlet)
# model.add_component("stator_dirichlet_right", len(stator_pbc_nodes_right), dirichlet)
# model.add_component("stator_node_49", 1, dirichlet_tooth_thickness_pos)
# model.add_component("stator_node_123", 1, dirichlet_tooth_thickness_neg)
# model.add_component("stator_node_173", 1, dirichlet_ag_pos)
# model.add_component("stator_node_176", 1, dirichlet_ag_neg)

# # Set the applied loads
# # model.add_component("force", 1, force)
# # model.link("force.dof", f"stator_node_src.v[{174}]")
...
# # Link nodes
# model.link("stator_ps.u", "stator_node_src.u", tgt_indices=stator_glob_conn)
# model.link("stator_ps.v", "stator_node_src.v", tgt_indices=stator_glob_conn)

# # Link BCs
# model.link("stator_node_src.v", "stator_node_49.dof", src_indices=[48])
# model.link("stator_node_src.v", "stator_node_123.dof", src_indices=[122])
# model.link("stator_node_src.v", "stator_node_173.dof", src_indices=[172])
# model.link("stator_node_src.v", "stator_node_176.dof", src_indices=[175])
# model.link(
#     "stator_node_src.u",
#     "stator_dirichlet_left.dof",
#     src_indices=stator_pbc_nodes_left,
# )
# # model.link(
# #     "stator_node_src.v",
# #     "stator_dirichlet_left.dof",
...
# # model.link(
# #     "stator_node_src.u",
# #     "stator_dirichlet_right.dof",
# #     src_indices=stator_pbc_nodes_right,
# # )
# # model.link(
# #     "stator_node_src.v",
# #     "stator_dirichlet_right.dof",
...
# u_stator = ans_local.get_array()[model.get_indices("stator_node_src.u")]
# v_stator = ans_local.get_array()[model.get_indices("stator_node_src.v")]
