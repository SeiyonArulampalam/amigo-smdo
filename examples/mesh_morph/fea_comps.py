...
class PDE1Dy(am.Component):
    def __init__(self):
        ...
        # Define inputs to the problem (displacements)
        self.add_input("dy", shape=(2,), value=0.0)
...
class DirichletBcNode4y(am.Component):
    def __init__(self):
        super().__init__()
        self.add_input("dy", value=1.0)
        self.add_input("lam", value=1.0)
        self.add_data("val")
        self.add_objective("morph_obj")
        return
...
class DirichletBcNode5y(am.Component):
    def __init__(self):
        super().__init__()
        self.add_input("dy", value=1.0)
        self.add_input("lam", value=1.0)
...
class DirichletBcNode6y(am.Component):
    def __init__(self):
        super().__init__()
        self.add_input("dy", value=1.0)
        self.add_input("lam", value=1.0)
...
class DirichletBcNode7y(am.Component):
    def __init__(self):
        super().__init__()
        self.add_input("dy", value=1.0)
        self.add_input("lam", value=1.0)
